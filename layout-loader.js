    ...
    <div class="border-t border-white/10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div class="flex gap-3">
          <a href="https://www.tiktok.com/@central.partido" target="_blank" rel="noopener" aria-label="TikTok" class="w-7 h-7 bg-white/10 hover:bg-amarillo-progreso hover:text-azul-institucional text-white rounded-md flex items-center justify-center transition-all duration-300">
